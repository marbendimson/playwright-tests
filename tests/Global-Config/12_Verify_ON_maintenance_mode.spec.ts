...
test.describe('Verify ON maintenance mode  ', () => {
  test('should be able to successfully ON and display Maintence mode word in multiportal ', async ({ page }) => {
...
await expect(mainInput).toHaveJSProperty('checked', true);
