...
test.describe('Login Error Tests', () => {
  ...
  test('should show error for empty form @dev @staging @preprod', async ({ page }) => {
  ...
  test('should show error for wrong username format @dev @staging @preprod', async ({ page }) => {
  ...
  test('should show error for short password @dev @staging @preprod', async ({ page }) => {
