...
import {deleteVMByNameIfExists} from '../../VMdeletionform';

test.describe('Delete Virtual Machine', () => {
  test('Should be able to successfully delete Virtual Machine - Service Provider @dev @staging @preprod', async ({ page }) => {
...
await vdcNav.click();
  ...
  await verifyVDCDetailsVisible(page);
  // Delete VM AND delete Proxmox data
await deleteVMByNameIfExists(page, 'AutoVM-001', true, true);
