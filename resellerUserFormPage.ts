...
export class ResellerUserFormPage {
  readonly page: Page;
  ...
  constructor(page: Page) {
    this.page = page;
    this.firstNameInput = page.locator('#resellerform-first_name');
    this.lastNameInput = page.locator('#resellerform-last_name');
    this.emailInput = page.locator('#resellerform-email');
    this.usernameInput = page.locator('#resellerform-username');
    this.roleDropdown = page.locator('#select2-resellerform-role-container');
...
export class EditResellerUserFormPage {
  readonly page: Page;
  readonly firstNameInput: Locator;
  readonly lastNameInput: Locator;
  readonly emailInput: Locator;
